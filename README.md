...
- **HomeSteadier.Database** — Migration and schema-generation logic, plus the DbUp SQL migration scripts in `Migrations/` (embedded resources) and reference-data CSVs in `Seeds/`
